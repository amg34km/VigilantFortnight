...
if __name__ == "__main__":
    XVG = ReadInfoData()
    XVG.skip_line_number = TableIO.countCommentLine(XVG.fname,[XVG.comment_tag,XVG.plot_tag])
    xvgTable = XVG.makeTable()
    print(xvgTable)
    print(XVG.atom_num_lists)
